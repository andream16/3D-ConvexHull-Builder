...
/**
 * @brief Aggiorna la scena e la centra tenendo conto di tutti gli oggetti visibili all'interno di essa
 * Da chiamare alla creazione della gui
 */
void MainWindow::updateAndFit() {
    ui->glCanvas->updateGL();
    ui->glCanvas->fitScene();
}
